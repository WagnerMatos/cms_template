...
# We need to ensure Rails doesn't add the default gems that we're adding
def remove_gem(name)
  gsub_file 'Gemfile', /^gem ["']#{name}["'].*$/, ''
end

# Remove default gems first to avoid duplicates
remove_gem 'propshaft'
remove_gem 'importmap-rails'
remove_gem 'turbo-rails'
remove_gem 'stimulus-rails'
remove_gem 'jbuilder'
remove_gem 'solid_cache'
remove_gem 'solid_queue'
remove_gem 'solid_cable'
remove_gem 'bootsnap'
remove_gem 'kamal'
remove_gem 'thruster'
remove_gem 'pg'
